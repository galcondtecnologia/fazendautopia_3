...
<h:body class="container">
 ...
 -->
			...
			<!-- 								Informações do produto selecionado (Descrição + qtd itens) -->
			<!-- 								<h:outputLabel style="padding:0.9em" class="descricao-produto" -->
			<!-- 									id="descricao-produto" value="Azeite 200ml Und"></h:outputLabel> -->

			<!-- 								Informações do produto selecionado (Preço com cifrão o padrão deve ser R$ 99,99) -->
			<!-- 								<h:outputLabel style="padding:0.9em;">R$</h:outputLabel> -->
			...
			<!-- 									<h:outputText -->
			<!-- 										value="Produtos 100% orgânicos. Cultivados sem agrotóxicos. Selecionados e com selo de qualidade" -->
			...
			<!-- 										<f:selectItem itemLabel="Selecione sua região" -->
